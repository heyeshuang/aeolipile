<template>
    <el-container v-loading="loading">
      <el-header><h3>Aeolipile - Steem Powered</h3></el-header>
      ...
      <el-footer v-show="loaded">
        <hr />
        <small>
          You can see the origin post at
        <a :href='steemitUrl+"@"+content.author+"/"+content.permlink'>steemit</a>.
          Also you may want to <a href="https://github.com/heyeshuang/aeolipile">Fork me on Github</a>.
        </small>
