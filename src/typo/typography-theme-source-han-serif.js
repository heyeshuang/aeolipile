...
const theme: OptionsType = {
  ...
  googleFonts: [{
    name: ['Open Sans'],
    styles: ['200', '400','700','900'],
  }, ],
  scaleRatio: 2.5,
  headerFontFamily: ["Source Han Serif SC",'Noto Serif CJK SC', 'Noto Serif CJK', 'Source Han Serif','source-han-serif-sc','Georgia', "Times New Roman",  "KaiTi", "楷体", 'STKaiti', "华文楷体", 'serif'],
